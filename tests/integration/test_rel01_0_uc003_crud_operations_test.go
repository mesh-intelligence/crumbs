...
// Validates test-rel01.0-uc003-crud-operations.yaml test cases.
// Implements: docs/test-suites/test-rel01.0-uc003-crud-operations.yaml;
//             docs/use-cases/rel01.0-uc003-crud-operations.yaml.
package integration
